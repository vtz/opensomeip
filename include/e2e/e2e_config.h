...
struct E2EConfig {
    ...
    /**
     * @brief E2E header offset in bits from the start of the Length-covered
     *        region (Request ID). Default 64 bits = 8 bytes, which places the
     *        header immediately after Return Code (feat_req_someip_102).
     *
