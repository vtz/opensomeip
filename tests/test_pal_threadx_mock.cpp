...
/**
 * PAL conformance tests for the ThreadX backend using mock RTOS headers.
 * No real ThreadX kernel needed — the mock header in tests/mocks/threadx/
 * implements the ThreadX API using std primitives.
 *
 ...
 * @tests REQ_PLATFORM_THREADX_001, REQ_PLATFORM_THREADX_002
 */
