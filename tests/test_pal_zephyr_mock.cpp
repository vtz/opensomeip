...
/**
 * PAL conformance tests for the Zephyr backend using mock RTOS headers.
 * No real Zephyr kernel needed — the mock header in tests/mocks/zephyr/
 * implements the Zephyr kernel API using std primitives.
 *
 ...
 * @tests REQ_PLATFORM_ZEPHYR_001, REQ_PLATFORM_ZEPHYR_002, REQ_PLATFORM_ZEPHYR_003, REQ_PLATFORM_ZEPHYR_004
 */
